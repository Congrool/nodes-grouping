...
import (
	...
	versioned "github.com/Congrool/nodes-grouping/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/Congrool/nodes-grouping/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/Congrool/nodes-grouping/pkg/generated/listers/groupmanagement/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GroupmanagementV1alpha1().PropagationPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupmanagementV1alpha1().PropagationPolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&groupmanagementv1alpha1.PropagationPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *propagationPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&groupmanagementv1alpha1.PropagationPolicy{}, f.defaultInformer)
}
